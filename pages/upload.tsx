    ...
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="relative flex items-center rounded-md shadow-sm">
          ...
          <input
            id="price"
            className=" w-full appearance-none rounded-md rounded-l-none border border-gray-300 px-3 py-2 pl-7 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
            type="text"
            placeholder="0.00"
          />
          <div className="pointer-events-none absolute right-0 flex pr-3 text-center">
